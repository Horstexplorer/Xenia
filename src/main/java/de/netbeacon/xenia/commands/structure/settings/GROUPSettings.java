...
package de.netbeacon.xenia.commands.structure.settings;

import de.netbeacon.xenia.commands.objects.CommandGroup;
import de.netbeacon.xenia.commands.structure.settings.guild.GROUPGuild;
import de.netbeacon.xenia.commands.structure.settings.user.GROUPUser;
