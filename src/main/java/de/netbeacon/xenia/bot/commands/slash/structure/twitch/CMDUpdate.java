...
public class CMDUpdate extends Command{
	...
	public CMDUpdate(){
		super("update", "Update stream notifications for a channel", false, new CommandCooldown(CommandCooldown.Type.User, 5000),
			null,
			...
			List.of(
				...
				new CmdArgDef.Builder<>("custom_message", "Custom notification message", "Custom notification message", String.class).build()
			)
		);
	}
