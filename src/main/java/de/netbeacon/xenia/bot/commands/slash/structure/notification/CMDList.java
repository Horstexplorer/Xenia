...
public class CMDList extends Command {
    ...
    public CMDList() {
        super("list", "View existing notifications", new CommandCooldown(CommandCooldown.Type.User, 2500),
                null,
                null,
    ...
    public void onExecution(CmdArgs cmdArgs, CommandEvent commandEvent, TranslationPackage translationPackage, boolean ackRequired) throws Exception {
        ...
        MessageEmbed messageEmbed = EmbedBuilderFactory.getDefaultEmbed(translationPackage.getTranslation(getClass(), "response.title"), commandEvent.getEvent().getJDA().getSelfUser(), commandEvent.getEvent().getUser())
