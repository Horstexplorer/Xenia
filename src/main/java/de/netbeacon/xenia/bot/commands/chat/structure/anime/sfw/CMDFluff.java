...
package de.netbeacon.xenia.bot.commands.chat.structure.anime.sfw;
...
public class CMDFluff extends AnimeImageCommand{

	public CMDFluff(){
		super("fluff", false, false, ImageType.SFW.FLUFF, ContentType.RANDOM);
	}
