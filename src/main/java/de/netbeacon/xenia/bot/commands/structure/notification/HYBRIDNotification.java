...
public class HYBRIDNotification extends HybridCommand {


    public HYBRIDNotification(CommandGroup parent) {
        super(parent, "notification", "View, manage and create notifications", new CommandCooldown(CommandCooldown.Type.User, 2500), null, null, null);
