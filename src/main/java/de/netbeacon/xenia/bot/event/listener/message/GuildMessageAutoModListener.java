...
import de.netbeacon.xenia.bot.event.handler.AutoModHandler;
...
public class GuildMessageAutoModListener extends ListenerAdapter{

	private final AutoModHandler autoModHandler;

	public GuildMessageAutoModListener(ToolBundle toolBundle){
		this.autoModHandler = new AutoModHandler(toolBundle);
	}
