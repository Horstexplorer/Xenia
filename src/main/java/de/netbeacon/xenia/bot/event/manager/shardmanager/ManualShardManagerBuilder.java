...
public class ManualShardManagerBuilder
{
	...
	protected ManualShardManagerBuilder(@Nullable String token, int intents)
	{
		this.token = token;
	...
	/**
	 * Creates a ManualShardManagerBuilder with recommended default settings.
	 ...
	 *
	 * @return The new ManualShardManagerBuilder
	 *
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createDefault(@Nullable String token)
	{
		return new ManualShardManagerBuilder(token, GatewayIntent.DEFAULT).applyDefault();
	}
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createDefault(@Nullable String token, @Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createDefault(@Nullable String token, @Nonnull Collection<GatewayIntent> intents)
	{
		return create(token, intents).applyDefault();
	}

	private ManualShardManagerBuilder applyDefault()
	{
	...
	/**
	 * Creates a ManualShardManagerBuilder with low memory profile settings.
	 * <br>Note that these defaults can potentially change in the future.
	 *
	 * <ul>
	 *     <li>{@link #setEnabledIntents(Collection)} is set to {@link GatewayIntent#DEFAULT}</li>
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createLight(@Nullable String token)
	{
		return new ManualShardManagerBuilder(token, GatewayIntent.DEFAULT).applyLight();
	}
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createLight(@Nullable String token, @Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
		Checks.notNull(intent, "GatewayIntent");
		Checks.noneNull(intents, "GatewayIntent");
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder createLight(@Nullable String token, @Nonnull Collection<GatewayIntent> intents)
	{
		return create(token, intents).applyLight();
	}

	private ManualShardManagerBuilder applyLight()
	{
	...
	/**
	 * Creates a completely empty ManualShardManagerBuilder with the predefined intents.
	 * <br>You can use {@link #create(Collection) ManualShardManagerBuilder.create(EnumSet.noneOf(GatewayIntent.class))} to disable all intents.
	 *
	 ...
	 *
	 * @return The ManualShardManagerBuilder instance
	 *
	 * @see   #setToken(String)
	 */
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder create(@Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder create(@Nonnull Collection<GatewayIntent> intents)
	{
		return create(null, intents);
	}

	/**
	 * Creates a ManualShardManagerBuilder with the predefined token.
	 * <br>You can use {@link #create(String, Collection) ManualShardManagerBuilder.create(token, EnumSet.noneOf(GatewayIntent.class))} to disable all intents.
	 *
	 * <p>If you don't enable certain intents, the cache will be disabled.
	 * For instance, if the {@link GatewayIntent#GUILD_MEMBERS GUILD_MEMBERS} intent is disabled, then members will only
	 * be cached when a voice state is available.
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder create(@Nullable String token, @Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
		return new ManualShardManagerBuilder(token, GatewayIntent.getRaw(intent, intents)).applyIntents();
	}
	...
	@Nonnull
	@CheckReturnValue
	public static ManualShardManagerBuilder create(@Nullable String token, @Nonnull Collection<GatewayIntent> intents)
	{
		return new ManualShardManagerBuilder(token, GatewayIntent.getRaw(intents)).applyIntents();
	}

	private ManualShardManagerBuilder applyIntents()
	{
	...
	private ManualShardManagerBuilder setDisabledCache(EnumSet<CacheFlag> flags)
	{
	 ...
	 *         If null is provided
	 *
	 * @return The ManualShardManagerBuilder instance. Useful for chaining.
	 *
	 * @since  4.2.1
	 */
	@Nonnull
	public ManualShardManagerBuilder setGatewayEncoding(@Nonnull GatewayEncoding encoding)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRawEventsEnabled(boolean enable)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRelativeRateLimit(boolean enable)
	{
	...
	public ManualShardManagerBuilder setEnabledCacheFlags(@Nullable EnumSet<CacheFlag> flags)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder enableCache(@Nonnull Collection<CacheFlag> flags)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder enableCache(@Nonnull CacheFlag flag, @Nonnull CacheFlag... flags)
	{
	...
	@ReplaceWith("enableCache(flags) and disableCache(flags)")
	@DeprecatedSince("4.2.0")
	public ManualShardManagerBuilder setDisabledCacheFlags(@Nullable EnumSet<CacheFlag> flags)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder disableCache(@Nonnull Collection<CacheFlag> flags)
	{
		Checks.noneNull(flags, "CacheFlags");
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder disableCache(@Nonnull CacheFlag flag, @Nonnull CacheFlag... flags)
	{
		Checks.notNull(flag, "CacheFlag");
		Checks.noneNull(flags, "CacheFlag");
	 ...
	 * <h2>Example</h2>
	 * <pre>{@code
	 * public void configureCache(ManualShardManagerBuilder builder) {
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setMemberCachePolicy(@Nullable MemberCachePolicy policy)
	{
		if (policy == null)
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setSessionController(@Nullable SessionController controller)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setVoiceDispatchInterceptor(@Nullable VoiceDispatchInterceptor interceptor)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setContextMap(@Nullable IntFunction<? extends ConcurrentMap<String, String>> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setContextEnabled(boolean enable)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setCompression(@Nonnull Compression compression)
	{
	...
	/**
	 * Adds all provided listeners to the list of listeners that will be used to populate the {@link ManualShardManager ManualShardManager} object.
	 ...
	 * @return The ManualShardManagerBuilder instance. Useful for chaining.
	 *
	 * @see    ManualShardManager#addEventListener(Object...) JDA.addEventListeners(Object...)
	 */
	@Nonnull
	public ManualShardManagerBuilder addEventListeners(@Nonnull final Object... listeners)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder addEventListeners(@Nonnull final Collection<Object> listeners)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder removeEventListeners(@Nonnull final Object... listeners)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder removeEventListeners(@Nonnull final Collection<Object> listeners)
	{
		Checks.noneNull(listeners, "listeners");
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder addEventListenerProvider(@Nonnull final IntFunction<Object> listenerProvider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder addEventListenerProviders(@Nonnull final Collection<IntFunction<Object>> listenerProviders)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder removeEventListenerProvider(@Nonnull final IntFunction<Object> listenerProvider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder removeEventListenerProviders(@Nonnull final Collection<IntFunction<Object>> listenerProviders)
	{
		Checks.noneNull(listenerProviders, "listener providers");
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setAudioSendFactory(@Nullable final IAudioSendFactory factory)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setAutoReconnect(final boolean autoReconnect)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setBulkDeleteSplittingEnabled(final boolean enabled)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEnableShutdownHook(final boolean enable)
	{
	...
	public ManualShardManagerBuilder setEventManager(@Nonnull final IEventManager manager)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEventManagerProvider(@Nonnull final IntFunction<? extends IEventManager> eventManagerProvider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setActivity(@Nullable final Activity activity)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setActivityProvider(@Nullable final IntFunction<? extends Activity> activityProvider)
	{
	 ...
	 * {@link ManualShardManager#setIdle(boolean) ManualShardManager#setIdleProvider(boolean)}.
	 *
	 * @param  idle
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setIdle(final boolean idle)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setIdleProvider(@Nullable final IntFunction<Boolean> idleProvider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setStatus(@Nullable final OnlineStatus status)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setStatusProvider(@Nullable final IntFunction<OnlineStatus> statusProvider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setThreadFactory(@Nullable final ThreadFactory threadFactory)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setHttpClientBuilder(@Nullable OkHttpClient.Builder builder)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setHttpClient(@Nullable OkHttpClient client)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRateLimitPool(@Nullable ScheduledExecutorService pool)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRateLimitPool(@Nullable ScheduledExecutorService pool, boolean automaticShutdown)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRateLimitPoolProvider(@Nullable ThreadPoolProvider<? extends ScheduledExecutorService> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setGatewayPool(@Nullable ScheduledExecutorService pool)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setGatewayPool(@Nullable ScheduledExecutorService pool, boolean automaticShutdown)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setGatewayPoolProvider(@Nullable ThreadPoolProvider<? extends ScheduledExecutorService> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setCallbackPool(@Nullable ExecutorService executor)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setCallbackPool(@Nullable ExecutorService executor, boolean automaticShutdown)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setCallbackPoolProvider(@Nullable ThreadPoolProvider<? extends ExecutorService> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEventPool(@Nullable ExecutorService executor)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEventPool(@Nullable ExecutorService executor, boolean automaticShutdown)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEventPoolProvider(@Nullable ThreadPoolProvider<? extends ExecutorService> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setAudioPool(@Nullable ScheduledExecutorService pool)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setAudioPool(@Nullable ScheduledExecutorService pool, boolean automaticShutdown)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setAudioPoolProvider(@Nullable ThreadPoolProvider<? extends ScheduledExecutorService> provider)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setMaxReconnectDelay(final int maxReconnectDelay)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setRequestTimeoutRetry(boolean retryOnTimeout)
	{
		return setFlag(ConfigFlag.RETRY_TIMEOUT, retryOnTimeout);
	}

	/**
	 * Sets the list of shards the {@link ManualShardManager ManualShardManager} should contain.
	 *
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setShards(final int... shardIds)
	{
	...
	/**
	 * Sets the range of shards the {@link ManualShardManager ManualShardManager} should contain.
	 * This is useful if you want to split your shards between multiple JVMs or servers.
	 *
	 * <p><b>This does not have any effect if the total shard count is set to {@code -1} (get recommended shards from discord).</b>
	 *
	 * @param  minShardId
	 *         The lowest shard id the ManualShardManager should contain
	 *
	 * @param  maxShardId
	 *         The highest shard id the ManualShardManager should contain
	 *
	 * @throws IllegalArgumentException
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setShards(final int minShardId, final int maxShardId)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setShards(@Nonnull Collection<Integer> shardIds)
	{
		Checks.notNull(shardIds, "shardIds");
	...
	/**
	 * This will set the total amount of shards the {@link ManualShardManager ManualShardManager} should use.
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setShardsTotal(final int shardsTotal)
	{
	 ...
	 * {@link ManualShardManagerBuilder#build() build()} is called.
	 *
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setToken(@Nonnull final String token)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setUseShutdownNow(final boolean useShutdownNow)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setWebsocketFactory(@Nullable WebSocketFactory factory)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setChunkingFilter(@Nullable ChunkingFilter filter)
	{
	...
	@DeprecatedSince("4.2.0")
	public ManualShardManagerBuilder setGuildSubscriptionsEnabled(boolean enabled)
	{
		if (!enabled)
		{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setDisabledIntents(@Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setDisabledIntents(@Nullable Collection<GatewayIntent> intents)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder disableIntents(@Nonnull Collection<GatewayIntent> intents)
	{
		Checks.noneNull(intents, "GatewayIntent");
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder disableIntents(@Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
		Checks.notNull(intent, "GatewayIntent");
		Checks.noneNull(intents, "GatewayIntent");
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEnabledIntents(@Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
		Checks.notNull(intent, "Intent");
		Checks.noneNull(intents, "Intent");
		EnumSet<GatewayIntent> set = EnumSet.of(intent, intents);
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setEnabledIntents(@Nullable Collection<GatewayIntent> intents)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder enableIntents(@Nonnull Collection<GatewayIntent> intents)
	{
		Checks.noneNull(intents, "GatewayIntent");
		int raw = GatewayIntent.getRaw(intents);
		this.intents |= raw;
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder enableIntents(@Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents)
	{
		Checks.notNull(intent, "GatewayIntent");
		Checks.noneNull(intents, "GatewayIntent");
		int raw = GatewayIntent.getRaw(intent, intents);
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setLargeThreshold(int threshold)
	{
	 ...
	 */
	@Nonnull
	public ManualShardManagerBuilder setMaxBufferSize(int bufferSize)
	{
	...
	public ShardManager build(boolean login) throws LoginException, IllegalArgumentException
	{
		...
		final ManualShardManager manager = new ManualShardManager(this.token, this.shards, shardingConfig, eventConfig, presenceConfig, threadingConfig, sessionConfig, metaConfig, chunkingFilter);
	...
	private ManualShardManagerBuilder setFlag(ConfigFlag flag, boolean enable)
	{
		if (enable)
			this.flags.add(flag);
		else
	...
	private ManualShardManagerBuilder setFlag(ShardingConfigFlag flag, boolean enable)
	{
		if (enable)
	...
	private void checkIntents()
	{
		...
		if (!membersIntent && memberCachePolicy == MemberCachePolicy.ALL)
			...
			ManualShardManager.LOG.warn("Member chunking is disabled due to missing GUILD_MEMBERS intent.");
		...
		if (!automaticallyDisabled.isEmpty())
		{
			...
			JDAImpl.LOG.warn("You can manually disable these flags to remove this warning by using disableCache({}) on your ManualShardManagerBuilder",
				automaticallyDisabled.stream()
					.map(it -> "CacheFlag." + it)
